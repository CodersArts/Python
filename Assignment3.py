...
def test():
    while True:
            menu()
            ch = input("Type your command:")
            if ch in cmdList:
                if ch == 'a':
                    exp1 = str(input("Type first polynomial: "))
                    exp2 = str(input("Type second polynomial: "))
                    parse_exp1=parse_string(exp1)
                    parse_exp2=parse_string(exp2)
                    print("Their sum is ",Polynomial(parse_exp1)+Polynomial(parse_exp2))
                elif ch == 's':
                    exp1 = str(input("Type first polynomial: "))
                    exp2 = str(input("Type second polynomial: "))
                    parse_exp1=parse_string(exp1)
                    parse_exp2=parse_string(exp2)
                    print("Their substraction is ",Polynomial(parse_exp1)-Polynomial(parse_exp2))
                elif ch == 'm':
                    exp1 = str(input("Type first polynomial: "))
                    exp2 = str(input("Type second polynomial: "))
                    parse_exp1=parse_string(exp1)
                    parse_exp2=parse_string(exp2)
                    print("Their multiplcation is ",Polynomial(parse_exp1)*Polynomial(parse_exp2))
                elif ch == 'e':
                    exp1 = str(input("Type first polynomial: "))
                    x1 = int(input("Choose value of x to evaluate: "))
                    parse_exp1=parse_string(exp1)
                    p1=Polynomial(parse_exp1)
                    val=p1(x1)
                    print("The value of your polynomial at x = ",x1,"is ",val)
            elif ch == 'q':
                    break    
            else:
                print("Invalid input")
